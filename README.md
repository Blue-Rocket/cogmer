...
[`docs/decisions.md`](docs/decisions.md) — 55 decisions with the alternatives
...
This project depends on 20 **undocumented** Claude Code behaviors — how hooks
...
```sh
claude-team doctor          # 12 session checks, one Claude turn, ~5s
